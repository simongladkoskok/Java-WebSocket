 ...
 */
public class SSLSocketChannel3 implements ByteChannel, WrappedByteChannel {
    ...
    public SSLSocketChannel3(SocketChannel channel , SSLEngine sslEngine , ExecutorService exec , SelectionKey key) throws IOException {
    ...
    private void handleHandshakeStatus(HandshakeStatus status) throws IOException {
    	...
    	if (status == HandshakeStatus.NOT_HANDSHAKING) return;
